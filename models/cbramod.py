"""Vendored from CBraMod (https://github.com/wjq-learning/CBraMod, MIT License).

CBraMod encoder used by the matched-pipeline foundation rerun. The released
semantics are preserved; only the local import path and the demo entry point
were adjusted.
"""
import torch
