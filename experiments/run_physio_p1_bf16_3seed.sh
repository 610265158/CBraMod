...
cd "${REPO_ROOT}"
EXPERIMENT_NAME="physio_p1_bf16_3seed_v1"

for seed in 3407 3408 3409; do
  echo "[$(date -Is)] START PhysioNet-MI P=1 lr=2e-3 bf16 seed=${seed}"
  ...
  echo "[$(date -Is)] DONE PhysioNet-MI P=1 lr=2e-3 bf16 seed=${seed}"
done
