...
class Model(nn.Module):
    def __init__(self, param):
        ...
        self.fc1 = nn.Linear(83200, out_features=param.num_of_classes, bias=True)
    ...
    def forward(self, x):
        ...
        # reshaped_tensor = x.view(bs, 1, ch_num, 400, 5)
        # reshaped_and_permuted_tensor = reshaped_tensor.permute(0, 1, 2, 4, 3)
        # x = reshaped_and_permuted_tensor.reshape(bs, 1, ch_num * 5, 400)
