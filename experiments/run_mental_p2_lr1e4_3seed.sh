...
cd "${REPO_ROOT}"
EXPERIMENT_NAME="mental_p2_lr1e4_3seed_v1"

for seed in 3407 3408 3409; do
  echo "[$(date -Is)] START MentalArithmetic P=2 lr=1e-4 epochs=10 roc_auc seed=${seed}"
  ...
  echo "[$(date -Is)] DONE MentalArithmetic P=2 lr=1e-4 epochs=10 roc_auc seed=${seed}"
done
