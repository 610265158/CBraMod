...
train_dir = '/nas/public/speech/Training set'
val_dir = '/nas/public/speech/Validation set'
test_dir = '/nas/public/speech/Test set'
...
db = lmdb.open('/nas/public/speech/processed', map_size=3000000000)
...
df = pd.read_excel("/nas/public/speech/Track3_Answer Sheet_Test.xlsx")
df_=df.head(53)
