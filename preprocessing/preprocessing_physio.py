...
root_dir = '/nas/public/eeg-motor-movementimagery-dataset-1.0.0/files'
...
db = lmdb.open('/nas/public/eeg-motor-movementimagery-dataset-1.0.0/processed_average', map_size=4614542346)
